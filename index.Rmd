...
```{r}
summary_table <- readRDS("_posts/global/nowcast/summary/summary_table.rds")
```
...
```
<br>
*Map of the expected change in daily cases*

## Aim

To identify changes in the reproduction number, rate of spread, and doubling time during the course of the COVID-19 outbreak whilst accounting for potential biases due to delays in case reporting both nationally and subnationally.
