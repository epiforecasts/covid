...
# int_linelist <- NCoVUtils::get_international_linelist("Pakistan")
# 
# # Get WHO sit rep case counts ---------------------------------------------
# 
# total_cases <- NCoVUtils::get_who_cases("Pakistan", daily = TRUE)
# 
# # Join imported and local cases -------------------------------------------
# 
# cases <- EpiNow::get_local_import_case_counts(total_cases, int_linelist,
#                                               cases_from = "2020-03-09") 
...
#   cases = cases,
#   linelist = linelist,
#   target_folder = file.path("results/pakistan", target_date),
