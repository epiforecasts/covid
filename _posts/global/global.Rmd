...
```{r}
summary_table <- readRDS ("analysis/summary/summary_table.rds")
```
...
knitr::include_graphics("analysis/summary/summary_plot.png")
```
...
knitr::include_graphics("analysis/summary/high_cases_rt_plot.png")
```
...
knitr::include_graphics("analysis/summary/high_cases_plot.png")
```
...
knitr::include_graphics("analysis/summary/rt_plot.png")
```
...
knitr::include_graphics("analysis/summary/cases_plot.png")
```
