...
## Summary of national estimates based on reported cases
...
## Summary of national estimates based on reported deaths

```{r}
standalone <- FALSE
tab_start <- 3
fig_start <- 8
summary_path <- "covid-rt-estimates/national/deaths/summary"
case_def <- "death"
```
