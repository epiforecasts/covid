...
```{r load-custom-data}
region_codes <- readRDS(here::here("_posts", "national", "colombia", "region_codes.rds"))
```


*Using data available up to the:* `r latest_date`

*Subnational estimates are available to download [here](https://github.com/epiforecasts/covid-rt-estimates/tree/master/subnational/colombia/cases/summary) and national estimates are available to download [here](https://github.com/epiforecasts/covid-rt-estimates/tree/master/national/cases/summary).*
