...
```{r}
summary_table <- readRDS("../../../_nowcasts/covid-regional-2/afghanistan/regional-summary/summary_table.rds")
latest_date <- readRDS("../../../_nowcasts/covid-regional-2/afghanistan/regional-summary/latest_date.rds")
region_codes <- readRDS("../../../_nowcasts/covid-regional-2/afghanistan/data/region_codes.rds")
...
* Case counts by date, stratified by region, were downloaded from a public curated dataset [@afghan-data-repo, @NCoVUtils].
...
standalone <- FALSE
region_path <- NULL
summary_path <- "_nowcasts/covid-regional-2/afghanistan/regional-summary"
```
