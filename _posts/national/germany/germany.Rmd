...
```{r}
summary_table <- readRDS("../../../_nowcasts/covid-regional/germany/regional-summary/summary_table.rds")
# region_codes <- readRDS("../../../_nowcasts/covid-regional/germany/data/region_codes.rds")
latest_date <- readRDS("../../../_nowcasts/covid-regional/germany/regional-summary/latest_date.rds")
...
* Case counts by date, stratified by region were downloaded from a publicly available source [@NCoVUtils; @noauthor_tabelle_2020].
* Case onset dates were estimated using case counts by date of report and a distribution of reporting delays fitted to a publicly available line-list of cases reported internationally [@kraemer2020epidemiological; @NCoVUtils].
...
standalone <- FALSE
region_path <- NULL
summary_path <- "_nowcasts/covid-regional/germany/regional-summary"
```
