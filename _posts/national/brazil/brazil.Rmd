...
```{r}
summary_table <- readRDS("../../../_nowcasts/covid-regional/brazil/regional-summary/summary_table.rds")
region_codes <- readRDS("../../../_nowcasts/covid-regional/brazil/data/region_codes.rds")
latest_date <- readRDS("../../../_nowcasts/covid-regional/brazil/regional-summary/latest_date.rds")
...
standalone <- FALSE
region_path <- NULL
summary_path <- "_nowcasts/covid-regional/brazil/regional-summary"
```
